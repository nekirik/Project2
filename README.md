...
1. Ошибка Not found, при поиске несуществующего города. В этом случае происходит редирект на главную страницу для повторного ввода
2. Ошибка API, у которой много вариантов(некорректный API, лимит исчерпан и прочее). При появлении такой происходит redirect на error.html
